...
class VolumeInfo {
  ...
  VolumeInfo.fromJson(dynamic json) {
    _title = json['title'];
    _authors = (json['authors'] as List<dynamic>?)?.map((author)=>author.toString()).toList();
    ...
    _readingModes = json['readingModes'] != null ? ReadingModes.fromJson(json['readingModes']) : ReadingModes();
    ...
    _panelizationSummary = json['panelizationSummary'] != null ? PanelizationSummary.fromJson(json['panelizationSummary']) : PanelizationSummary();
